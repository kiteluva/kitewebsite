    ...
    <div className="min-h-screen bg-black text-white font-sans selection:bg-purple-500 selection:text-white overflow-x-hidden">
        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex flex-col md:flex-row justify-between items-center gap-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-tr from-purple-600 to-blue-500 flex items-center justify-center overflow-hidden shadow-lg shadow-purple-500/20">
               ...
               <img src="../public/images/about.jpg" alt="Profile" className="w-full h-full object-cover" />   
            </div>
            <div>
          ...
          <div className="hidden md:flex items-center gap-4 text-neutral-400">
            <a href="https://github.com/kiteluva" target="_blank" className="hover:text-white transition-colors"><Github size={20} /></a>
            <a href="https://linkedin.com/in/kiteluva08" target="_blank" className="hover:text-white transition-colors"><Linkedin size={20} /></a>
      ...
      <footer className="border-t border-neutral-900 bg-neutral-950 pt-16 pb-8">
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          <div>
            <h3 className="text-lg font-bold mb-4">Kiluva Analysis</h3>
            ...
            <div className="flex gap-4">
              <a href="https://instagram.com/itskite_luva" target="_blank" className="p-2 bg-neutral-900 rounded-lg hover:bg-neutral-800 transition-colors"><Instagram size={18} /></a>
              <a href="https://twitter.com/@KitenyeK" target="_blank" className="p-2 bg-neutral-900 rounded-lg hover:bg-neutral-800 transition-colors"><Twitter size={18} /></a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li><button onClick={() => setActiveTab('projects')} className="text-neutral-400 hover:text-white transition-colors">Data Services</button></li>
              ...
              <div className="p-8 md:p-12">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-[10px] font-bold uppercase tracking-widest text-neutral-500 flex items-center gap-1">
                    <Award size={12} /> {selectedProject.origin || 'Professional'}
                  </span>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-4">
                  {selectedProject.github && (
                    <a href={selectedProject.github} target="_blank" className="flex-1 py-3 bg-white text-black text-center font-bold rounded-xl flex items-center justify-center gap-2 hover:bg-neutral-200 transition-all">
                      <Github size={18} /> Source Code
                    </a>
                  )}
                  {selectedProject.live && (
                    <a href={selectedProject.live} target="_blank" className="flex-1 py-3 border border-neutral-700 text-white text-center font-bold rounded-xl flex items-center justify-center gap-2 hover:bg-neutral-900 transition-all">
  ...
  <div className="space-y-24 animate-in fade-in duration-700">
    <section className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
      <div>
        ...
        <h2 className="text-5xl md:text-7xl font-extrabold leading-[1.1] mb-6">
          Architecting <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 to-blue-500">Intelligence</span> Thru Data.
        </h2>
        <p className="text-neutral-400 text-lg mb-8 max-w-lg">
          I'm a Data Scientist and Web Developer focused on building automated systems that transform raw information into strategic digital assets.
        </p>
      ...
      <div className="relative group">
        ...
        <ProjectCardImage text="Profile & Identity" imageSrc="../public/images/profile.jpg" height="h-[500px]" />
      </div>
    </section>
    ...
    <section>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[
          { icon: <BarChart3 className="text-blue-400" />, title: "Data Analysis", desc: "Expertise in SQL, Python, and Tableau to uncover trends and build predictive forecasting dashboards." },
          { icon: <BrainCircuit className="text-purple-400" />, title: "AI/ML Dev", desc: "Crafting custom recommendation engines, sentiment analysis tools, and LLM-powered automation." },
          { icon: <Code2 className="text-emerald-400" />, title: "Digital Solutions", desc: "Responsive full-stack applications with high performance and integrated data management." }
        ].map((s, i) => (
    ...
    <section className="bg-neutral-900/20 rounded-3xl p-8 md:p-12 border border-neutral-800/50">
      <div className="flex flex-col md:flex-row gap-12 items-center">
        <div className="w-full md:w-1/3">
          <ProjectCardImage text="Creative" imageSrc="../public/images/kada.png" height="h-72" />
        </div>
        <div className="w-full md:w-2/3">
          <h3 className="text-2xl font-bold mb-6 flex items-center gap-3">
            <UserCircle2 className="text-purple-500" /> About Kiteluva
          </h3>
          ...
          <div className="flex flex-wrap gap-3">
            {['Critical Thinking', 'Fast Learner', 'Visualization', 'Strategy'].map((skill) => (
...
const ProjectsView = ({ setSelectedProject, ProjectCardImage }) => {
  ...
  const projectData = [
    ...
    { 
      ...
      category: "data, Tech & AI", 
      origin: "Personal",
      desc: "Automated tool for extraction and analysis of multi-sector Data. Designed for technical and non-technical users a like; KADA bridges the gap between raw data and actionable insights.", 
      longDesc: "Designed to help small businesses track their performance without needing deep technical expertise. Features include data cleaning, visualization, and report generation. Built with Python and BeautifulSoup for web scraping and data processing.",
      tags: ["Python", "BS4", "Automation", "Data Analysis","Generative AI", "FastAPI", "React"],
    ...
    { 
      ...
      longDesc: "Leveraged descriptive and diagnostic analytics to identify risk factors. Provided a clear roadmap for administration to improve student experiences. Full PDF findings on GitHub.",
    ...
    { 
      ...
      category: "data", 
      origin: "School",
      desc: "Interactive dashboard system for monitoring sales and operational KPIs.", 
      ...
      github: "https://github.com/kiteluva"
    },
    // --- AI ---
    ...
    { 
      ...
      category: "ai", 
      origin: "School",
      desc: "High-accuracy NLP engine for classifying feedback and social sentiment.", 
      longDesc: "Trained on large datasets to recognize nuance in customer reviews. Achieved 92% accuracy on test benchmarks.",
    ...
    { 
      ...
      tags: ["Scikit-Learn", "Regression", "Math"],
      github: "https://github.com/kiteluva/popularity_regression_and_classification_analysis"
    },
    // --- TECH ---
    ...
    { 
      ...
      longDesc: "Includes dynamic service listings, client intake forms, and an optimized performance architecture. Built to be a primary business portal.",
      tags: ["Tailwind", "JS", "Design"],
      github: "https://github.com/kiteluva",
      live: "https://kiteluva.github.io/KADSA/"
    },
    { 
      title: "E-Commerce Infrastructure", 
      category: "tech", 
      origin: "Personal",
      desc: "Robust online shopping system with payment integration and inventory sync.", 
      longDesc: "Focused on speed and user experience. Implements secure checkout and a modular admin panel for vendor management.",
    ...
    { 
      ...
      category: "tech", 
      origin: "Personal",
      desc: "The original multi-page HTML/CSS portfolio designed for rapid exploration.", 
      longDesc: "A project in itself, focusing on pure CSS animations and traditional web structure.",
    ...
    <div className="grid grid-cols-1 md:grid-cols-5 gap-12 items-start">
      <div className="md:col-span-2 space-y-6">
        ...
        <div className="space-y-3">
          ...
          <a href="https://linkedin.com/in/kiteluva08" target="_blank" className="flex items-center justify-between p-4 bg-neutral-800 text-white rounded-xl font-bold hover:bg-neutral-700 transition-all">
        ...
        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              ...
              <input type="text" className="w-full bg-neutral-900 border border-neutral-800 rounded-xl p-4 focus:border-purple-500 outline-none transition-all" placeholder="Full Name" />
            </div>
            <div className="space-y-2">
              <label className="text-xs font-bold uppercase tracking-widest text-neutral-500">Contact Point</label>
              <input type="email" className="w-full bg-neutral-900 border border-neutral-800 rounded-xl p-4 focus:border-purple-500 outline-none transition-all" placeholder="Email" />
            </div>
          </div>
          <div className="space-y-2">
            <label className="text-xs font-bold uppercase tracking-widest text-neutral-500">Project Type</label>
            <select className="w-full bg-neutral-900 border border-neutral-800 rounded-xl p-4 focus:border-purple-500 outline-none transition-all">
          ...
          <div className="space-y-2">
            ...
            <textarea rows="5" className="w-full bg-neutral-900 border border-neutral-800 rounded-xl p-4 focus:border-purple-500 outline-none transition-all" placeholder="How can I help your business?"></textarea>
          </div>
