      ...
      <div className="flex flex-col md:flex-row gap-12 items-start text-left">
        ...
        <div className="w-full md:w-2/3">
          ...
          <div className="space-y-6 text-neutral-400 leading-relaxed">
            ...
            <p>
              <a href="https://the-website-chi.vercel.app" target="_blank" rel="noopener noreferrer" className="text-italic font-light hover:text-blue-400 transition-colors duration-200 flex items-center gap-1.5"> This vision led to the founding of 
                <img src="/images/icon2.png" alt="icon" className="w-4 h-4 inline-block" /> 
                <strong>KADSA</strong> —a company dedicated to pushing the boundaries of Data, Tech, and AI. Through the KADSA Academy and our innovation pool, we provide quality knowledge to feed the ideas of innovators who, like me, come from backgrounds where amenities are scarce but potential is infinite.
              </a> 
            </p>
          </div>
